...
public class ExceptionTest {
    ...
    public void level1() {
        try {
            ...
            this.exceptionHandler.handle("L1", "E1", "Error in level 1, calling level 2", e);
            throw e;
        }
    }
    ...
    public void level2() {
        try {
            ...
            this.exceptionHandler.handle("L2", "E2", "Error in level 2, calling level 3", e);
            throw e;
        }
    }
    ...
    public void level3() {
        try {
            ...
            this.exceptionHandler.handle("L3", "E3", "Error at level 3, calling level 4", e);
        }
    }
